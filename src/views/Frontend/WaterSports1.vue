      ...
      <div class="row py-5">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb  mb-5">
            ...
            <li class="breadcrumb-item ">
              <router-link class="text-light" to="/">Products</router-link>
            </li>
        ...
        <div class="col-md-4 col-6 mb-3">
          ...
          <button type="button" class="btn  border-0  px-0 watersports-card" data-bs-toggle="modal"
            ...
            <img src="@/assets/images/Frontend/Products/WaterSports/qdry-fleece.jpg" class="img-fluid rounded watersports-card"
              alt="ECO Qdry Fleece">
            </div>
...
.pic-effect{
  height:200px; overflow:hidden; border-radius: 6px;
}
